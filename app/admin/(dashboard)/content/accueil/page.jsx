...
const LEGACY_META = {
    ...
    Hero:           { icon: '🖼', label: 'Héro principal' },
...
export default function AccueilContentPage() {
    ...
    return (
        <div style={{ height: '100vh', display: 'flex', flexDirection: 'column', background: '#f1f5f9', overflow: 'hidden' }}>
            ...
            {!isFullscreen && (
                <header style={{
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
                        ...
                        <div>
                            <h1 style={{ fontSize: '1.1rem', fontWeight: 800, color: '#0f172a', margin: 0 }}>🏠 Page d'Accueil</h1>
                            <code style={{ fontSize: '0.72rem', color: '#94a3b8' }}>/</code>
                        </div>
                    </div>
                    <div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
                        ...
                        {/* View live */}
                        <a href="https://www.lesamisducbd.fr" target="_blank" rel="noopener noreferrer" style={{
            ...
            {showSEOModal && (
                <SEOPanel
                    page={{ slug: '', title: 'Page d\'Accueil', seo: meta.seo || {}, status: 'published' }}
                    sections={previewSections}
                    onUpdate={(patch) => {
